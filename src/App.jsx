...
export default function App() {
  ...
  const HomeWelcome = () => {
    ...
    // Почти на всю ширину экрана (~2× от прежних 260)
    const logoW = Math.min(360, winW - 24);
    const logoH = Math.round(logoW * (98 / 535) * 1.15); // чуть выше по высоте
    const logoTop = Math.round(winH / 2 - logoH / 2);

    return (
      <View style={[styles.homePage, { minHeight: winH }]}>
        <View style={[styles.homeColumn, { paddingTop: logoTop }]}>
          <Image
            source={{ uri: LOGO_URI }}
